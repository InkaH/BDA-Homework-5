...
datapath_train = utils.get_file("datapath_train", "file:/valohai/inputs/datapath_train/train-set-images.tar.gz", extract=True, archive_format='auto')
datapath_validation = utils.get_file("datapath_validation", "file:/valohai/inputs/datapath_validation/validation-set-images.tar.gz", extract=True, archive_format='auto')
datapath_test = utils.get_file("datapath_test", "file:/valohai/inputs/datapath_test/test-set-images.tar.gz", extract=True, archive_format='auto')
